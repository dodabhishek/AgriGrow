      ...
      <section className="relative py-16 px-4 bg-white overflow-hidden">
        <div className="max-w-4xl mx-auto text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Connect with agricultural experts, get personalized consultations, field visits, 
            and access modern tools to maximize your harvest potential.
          </p>
        </div>
      </section>
              ...
              if (isEquipment(item)) {
                return (
                  <div
                    ...
                    onClick={() =>
                      navigate(`/shop/equipment/${item._id}`, {
                        state: { product: item, fromSection: selectedType },
                      })
                    }
                  >
                    <ExpertCard
